...
<petclinic:layout pageName="tienda">
    ...
    <p style="font-size: large;">
        ...
        https://volleymate-wpl.ew.r.appspot.com/ , se incluyen en los ficheros automatizados específicos de usuarios de los
        ...
        a la finalidad anteriormente expuesta.<br/>
        VOLLEYMATE SA adopta las medidas necesarias para garantizar la seguridad, integridad y confidencialidad de los datos
        conforme a lo dispuesto en el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016,
        ...
        https://volleymate-wpl.ew.r.appspot.com/, con las siguientes finalidades:<br/>
        1. En caso de contratación de los bienes y servicios ofertados a través de
        https://volleymate-wpl.ew.r.appspot.com/, para mantener la relación contractual, así como la gestión,
        ...
        https://volleymate-wpl.ew.r.appspot.com/ <br/>
        ...
        1. La solicitud de información y/o la contratación de los servicios de VOLLEYMATE SA, cuyos términos y
        condiciones se pondrán a tu disposición en todo caso, de forma previa a una eventual contratación.<br/>
        ...
        <br/>
        Destinatarios:<br/>
        Los datos no se comunicarán a ningún tercero ajeno a VOLLEYMATE SA, salvo obligación legal.
        ...
        ● (ENCARGADO) JUAN LÓPEZ QUIRÓS, con domicilio en
        C. Adriano, 24, 41001 Sevilla, NIF/CIF no 23459842S, presta servicios de
        ...
        enlace: https://volleymate-wpl.ew.r.appspot.com/terminos<br/>
        <br/>
        ...
        compartido, VOLLEYMATE SA no se hace responsable del incumplimiento por parte del usuario del RGPD.<br/>
        <br/>
        Retención de datos en conformidad a la LSSI<br/>
        VOLLEYMATE SA informa de que, como prestador de servicio de alojamiento de datos y en virtud de lo establecido en
        la Ley 34/2002 de 11 de julio de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSI), retiene por un
        periodo máximo de 12 meses la información imprescindible para identificar el origen de los datos alojados y el momento
        en que se inició la prestación del servicio. La retención de estos datos no afecta al secreto de las comunicaciones y sólo
        podrán ser utilizados en el marco de una investigación criminal o para la salvaguardia de la seguridad pública, poniéndose
        a disposición de los jueces y/o tribunales o del Ministerio que así los requiera.<br/>
        ...
        otros derechos guardan relación con los contenidos del sitio web https://volleymate-wpl.ew.r.appspot.com/ y los
        ...
        sitio web https://volleymate-wpl.ew.r.appspot.com/ sin el consentimiento previo y por escrito.<br/>
        <br/>
        ...
        y/o de disposición pública.<br/>
        VOLLEYMATE SA dispone de los derechos de explotación y propiedad intelectual necesarios del software.<br/>
        ...
        VOLLEYMATE SA, quedando prohibido al usuario acceder, modificar, visualizar la configuración, estructura y ficheros
        de los servidores propiedad de VOLLEYMATE SA, asumiendo la responsabilidad civil y penal derivada de cualquier
        incidencia que se pudiera producir en los servidores y sistemas de seguridad como consecuencia directa de una actuación
        negligente o maliciosa por su parte.<br/>
        <br/>
        ...
        VOLLEYMATE SA y, en particular de:<br/>
        <br/>
        • La utilización que resulte contraria a las leyes españolas o que infrinja los derechos de terceros.<br/>
        • La publicación o la transmisión de cualquier contenido que, a juicio de VOLLEYMATE SA, resulte<br/>
        ...
        El usuario indemnizará a VOLLEYMATE SA por los gastos que generara la imputación de
        VOLLEYMATE SA en alguna causa cuya responsabilidad fuera atribuible al usuario, incluidos honorarios y gastos de
        defensa jurídica, incluso en el caso de una decisión judicial no definitiva.<br/>
        <br/>
        Protección de la información alojada
        VOLLEYMATE SA realiza copias de seguridad de los contenidos alojados en sus servidores, sin embargo no se
        responsabiliza de la pérdida o el borrado accidental de los datos por parte de los usuarios. De igual manera, no garantiza
        la reposición total de los datos borrados por los usuarios, ya que los citados datos podrían haber sido suprimidos y/o
        modificados durante el periodo del tiempo transcurrido desde la última copia de seguridad.
        Los servicios ofertados, excepto los servicios específicos de backup, no incluyen la reposición de los contenidos
        conservados en las copias de seguridad realizadas por VOLLEYMATE SA, cuando esta pérdida sea imputable al usuario;
        ...
        causas atribuibles a VOLLEYMATE SA.<br/>
        <br/>
        Comunicaciones comerciales<br/>
        En aplicación de la LSSI. VOLLEYMATE SA no enviará comunicaciones publicitarias o promocionales por correo
        electrónico u otro medio de comunicación electrónica equivalente que previamente no hubieran sido solicitadas o
        expresamente autorizadas por los destinatarios de las mismas.<br/>

        En el caso de usuarios con los que exista una relación contractual previa, VOLLEYMATE SA , sí está autorizado al
        envío de comunicaciones comerciales referentes a productos o servicios de
        VOLLEYMATE SA que sean similares a los que inicialmente fueron objeto de contratación con el cliente.
        En todo caso, el usuario, tras acreditar su identidad, podrá solicitar que no se le haga llegar más información comercial a
        través de los canales de Atención al Cliente.<br/>
    </p>
